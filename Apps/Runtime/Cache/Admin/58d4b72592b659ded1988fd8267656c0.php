        ...
        <div class="form form-horizontal" id="form-article-add">
            <div class="clearfix cl">
                ...
                <div class="col-lg-8 col-md-8" >
                    <div id="f_title"><input type="text" class="input-text" value="<?php echo ($data["title"]); ?>" placeholder="" name="title" id="title"></div>
                </div>
            </div>
            <!--<div class="clearfix cl">-->
                ...
                <!--<div class="col-lg-8 col-md-8" >-->
                    <!--<select id="catid" name='catid' >-->
                        <!--<?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
                            <!--<?php if($vo['id'] == $data['catid']): ?>-->
            ...
            <div class="clearfix cl">
                <div class="Button_operation">
                    ...
                    <button class="btn btn-default radius" type="reset" onclick="history.back()">&nbsp;&nbsp;返回&nbsp;&nbsp;</button>
...
<script>
    ...
    var Check = {
        ...
        checkSubmit : function() {
            ...
            $.ajax(
                {
                    url:'/admin.php/Complain/savecomplain',
                    data:data,
                    type:'POST',
                    dataType:'json',
                    success:function(json){
                        ...
                        if(json.flag==1){
                            layer.msg('成功!',{icon:1,time:2000},function(){
                                window.location.href="/admin.php/Complain";
