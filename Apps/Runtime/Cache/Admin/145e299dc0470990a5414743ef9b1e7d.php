        ...
        <div class="form form-horizontal" id="form-article-add">
            ...
            <div class="clearfix cl">
                ...
                <div class="col-lg-6 col-md-6" id="">
                    <img src="https://quanyu.xcxweshine.com/<?php echo ($data["cover"]); ?>" id="coverimg" width="375px" height="200" style="border:1px solid lightgrey" alt="">
                </div>
            </div>
...
<script>
    ...
    var Check = {
        ...
        checkSubmit : function() {
            ...
            if (mapword==''){
                layer.msg("请上传地图定位！",{icon:2,time:1000},function(){});
                return false;
            }
            var data = {
                id:id,
            ...
            $.ajax(
                {
                    url:'/admin.php/Experience/saveexperience',
                    data:data,
                    type:'POST',
                    dataType:'json',
                    success:function(json){
                        ...
                        if(json.flag==1){
                            layer.msg('成功!',{icon:1,time:2000},function(){
                                window.location.href="/admin.php/Experience";
