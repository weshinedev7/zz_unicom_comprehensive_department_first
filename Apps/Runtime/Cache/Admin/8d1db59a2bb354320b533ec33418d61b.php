            ...
            <!--<div class="clearfix cl">-->
                ...
                <!--<div class="col-lg-8 col-md-8" >-->
                    <!--<select id="catid" value="<?php echo ($data["catid"]); ?>">-->
                        <!--<option value="4">出游提示</option>-->
                        <!--<option value="5">星级农家乐介绍</option>-->
...
<script>
    ...
    var Check = {
        ...
        checkSubmit : function() {
            ...
            // }
            if(video==''){
                layer.msg("请上传视频!",{icon:2,time:1000},function () {
                    ...
                    success:function(json){
                        ...
                        if(json.flag==1){
                            layer.msg('成功!',{icon:1,time:2000},function(){
                                window.location.href="/admin.php/Video";
