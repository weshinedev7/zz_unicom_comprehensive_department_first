...
<script>
    ...
    var Check = {
        ...
        checkSubmit : function() {
            ...
            var data = {id:id,audioid:audioid,name:name,introduction:introduction,content:content,cover:cover,price:price,audio:audio,video:video};

                $.ajax(
                    {
                        url:'/admin.php/Science/savescience',
                        data:data,
                        type:'POST',
                        dataType:'json',
                        success:function(json){
                            ...
                            if(json.flag==1){
                                layer.msg('成功!',{icon:1,time:2000},function(){
                                    window.location.href="/admin.php/Science";
