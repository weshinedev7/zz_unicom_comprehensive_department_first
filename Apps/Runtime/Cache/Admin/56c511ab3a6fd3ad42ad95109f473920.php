...
<div class="clearfix" id="add_picture">
    <div class="page_right_style" style="left:0px;width: 100%;">
        ...
        <div class="form form-horizontal" id="form-article-add">
            ...
            <label class="col-lg-2 col-md-2 col-sm-12 control-label"><span class="c-red" style="color:red;">*&nbsp;&nbsp;</span>分类名称：</label>
            ...
            <!--<div class="col-lg-8 col-md-8" >-->
            <!--<select id="catid" value="<?php echo ($data["catid"]); ?>">-->
            <!--<option value="2">精品旅游介绍</option>-->
            <!--<option value="3">星级农家乐介绍</option>-->
            <!--</select>-->
            <!--</div>-->
            <!--</div>-->
            <!--<div class="clearfix cl">-->
...
<script>
    ...
    var Check = {
        ...
        checkSubmit : function() {
            ...
            // }
            if (name==''){
                layer.msg("请填写分类名称！",{icon:2,time:1000},function(){});
                return false;
            }
            // if (audio==''){
            ...
            $.ajax(
                {
                    url:'/admin.php/Traffic/savecategory',
                    data:data,
                    type:'POST',
                    dataType:'json',
                    success:function(json){
                        ...
                        if(json.flag==1){
                            layer.msg('成功!',{icon:1,time:2000},function(){
                                window.location.href="/admin.php/Traffic";
