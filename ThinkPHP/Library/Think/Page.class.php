...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    ///protected $config  =    array('header'=>'条记录','prev'=>'<','next'=>'>','first'=>'<<','last'=>'<span id="lastspan">>></span>','theme'=>'<ul><li><span> %totalRow% %header% %nowPage%/%totalPage% 页</span></li> %first%  %upPage% %prePage%  %linkPage% %downPage%  %nextPage% %end%</ul>');
	protected $config  =    array('header'=>'条记录','prev'=>'<','next'=>'>','first'=>'<<','last'=>'<span id="lastspan">>></span>','theme'=>'<ul><li><span> %totalRow% %header% %nowPage%/%totalPage% </span></li> %first%  %upPage% %prePage%  %linkPage% %downPage%  %nextPage% %end%</ul>');
    // 默认分页变量名
    protected $varPage;
    /**
     * 架构函数
