...
var Check = {
    ...
    /*    $("#url") && Check.checkUrl();
        ...
        hasError=false;
        if (hasError) {
			layer.msg("请填写真确的广告信息！",{icon:2,time:1000},function(){});
            return false;
        }
		else
		{
            ...
            var data = {url:url,album_id:album_id};
			$.ajax(
				{
					url:'/admin.php/Banner/insert',
					data:data,
					type:'POST',
					dataType:'json',
					success:function(json){
						...
						if(json.flag==1){
							...
							layer.msg('广告添加失败!',{icon:2,time:1000},function(){return false;});
						}
					}
				}
			)
